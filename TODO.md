...
- [x] V8 courant : **3 013 PDF** après SHEC `+2`.
- [x] checkpoint courant : `inventory/P1_48_ISSUERS_CHECKPOINT_v8_20260809.md`.
...
- [x] maître consolidé : **14 / 3 013** lignes.
- [x] BIIC 2/2.
- [x] TRITRAF 8/8.
...
- [ ] backfill métadonnées temporelles + shards compatibles SICC/MVSC/UNLC/ORGT/SHEC.
- [ ] STAC : revérifier le total live avant hash.
...
- [x] MVSC/UNLC/ORGT/SHEC : contrôle taille Drive ↔ fichier hashé appliqué pendant la passe.
